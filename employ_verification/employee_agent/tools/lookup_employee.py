...
from employee_agent.tools.bq_client import (
    OBOSessionExpiredError,
    get_bigquery_client,
    run_query,
    PROJECT_ID,
)
...
def lookup_employee(
    ...
    try:
        ...
        results = run_query(client, query, job_config=job_config)
    ...
    except OBOSessionExpiredError as e:
        logger.warning(f"  - OBO session expired: {e}")
