...
def create_agent() -> Agent:
    ...
    # No bundled A2UI examples are shipped with this agent — the schema
    # manager gracefully renders an empty examples section when
    # examples_path is None (see a2ui.schema.catalog.load_examples).
