...
AGENT_NAME = "KPMGAuditIssueTrackerAgent"
...
IMPORTANT: When your tools return a block starting with <a2ui-json> and ending with
</a2ui-json>, you MUST copy and print that block EXACTLY as-is at the end of your
response. Do NOT modify, truncate, reformat, or summarize the <a2ui-json> block.
This is what renders the Kanban board in the side panel.
...
1. SHOWING THE KANBAN BOARD:
   ...
   - The tool returns both a text summary AND an <a2ui-json> block.
   - Provide a brief text summary of the issues (counts by severity/status).
   - Then copy the <a2ui-json> block verbatim at the end of your response.
