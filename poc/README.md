...
| Raw JSON in chat bubble | Model emitted wire-format (`kind`/`mimeType`) or concatenated JSON the old parser missed | Fixed in `a2ui_utils.py` — **+New Session** after restart |
